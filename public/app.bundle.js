...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLocationJSON = _regeneratorRuntime.mark(function getLocationJSON() {
		return _regeneratorRuntime.wrap(function getLocationJSON$(context$1$0) {
	...
	document.addEventListener("DOMContentLoaded", function () {
		co(getLocationJSON).then(initLocation).then(addEvents).then(startPolling)["catch"](function (err) {
	...
	function startPolling(iss) {
		timer = setInterval(function () {
			co(getLocationJSON).then(updateLocation)["catch"](function (err) {
				clearInterval(timer);
				console.log(err.stack);
			});
		}, updateTimeInterval);
